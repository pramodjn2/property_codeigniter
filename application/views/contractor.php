...
<div class="main-container"> 
  ...
  <section class="wrapper wrapper-grey padding50 findagentwrap">
    <div class="container_inn">
      <div class="row">
        <div class="threepeople"> <img src="<?php echo base_url();?>assets/images/findagent-3people.png" alt="solicitor"> </div>
        <h3>FIND YOUR CONTRACTOR</h3>
        ...
        <section class="wrapper wrapper-grey padding50 tophead_searching">
          <div class="container_inn">
            <div class="row">
              <div class="col-md-12">
                <form id="contactForm" novalidate action="<?php echo base_url();?>contractor/listing" method="post">
                  <div class="row">
                    <div class="form-group">
                      ...
                      <div class="col-md-2">
                        <div class="form-group">
                          <input type="text" value="" data-msg-required="contractor name" maxlength="100" class="form-control" name="name"  placeholder="contractor Name">
                        </div>
                      </div>
                      <div class="col-md-2">
                        <div class="form-group">
                      ...
                      <div class="col-md-2">
                        <div class="form-group">
                          <select name="specialities" id="" class="form-control search-select">
                            <option value="">contractor Specialities</option>
