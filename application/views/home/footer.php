...
<script src="<?php echo config_item('base_url');?>assets/plugins/jQuery-lib/1.10.2/jquery.min.js" type="text/javascript"></script>
<![endif]--> 
<!--[if gte IE 9]><!--> 
...
<script src="<?php echo config_item('base_url');?>assets/plugins/bootstrap/js/bootstrap-formhelpers.min.js"></script> 
...
<script src="<?php echo config_item('base_url');?>assets/js/front-end-main-home.js"></script> 
...
<?php 
        	if(isset($scriptsrc) && !empty($scriptsrc)){
				...
				foreach($scriptsrc as $value){$i++;
					$tab = ($i!=1)?"\t\t ":"";
					echo $tab.'<script src="'.config_item('base_url').$value.'" type="text/javascript"></script>'."\n";
				}
			}
		...
		?>		
        <style type="text/css">
textarea, input[type="text"], input[type="password"], input[type="datetime"], input[type="datetime-local"], input[type="date"], input[type="month"], input[type="time"], input[type="week"], input[type="number"], input[type="email"], input[type="url"], input[type="search"], input[type="tel"], input[type="color"], select{border-radius:5px !important;}
.red_button{border-radius:5px !important;}
</style>

<script>
//var tc;
$(document).ready(function(e) {	
	$("#currency").msDropdown({mainCSS:'transparent'}).data("dd");//{animStyle:'none'} /{animStyle:'slideDown'} {animStyle:'show'}
});
