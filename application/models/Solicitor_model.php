<?php
class Solicitor_model extends CI_Model {

function solicitorListingCount($post= NULL){
    ...
    function solicitorListing($limit, $offset, $post= NULL,$type = 'array'){
  ...
  public function solicitorDetails($id = NULL){
    if(empty($id)){
       return false;
       }
